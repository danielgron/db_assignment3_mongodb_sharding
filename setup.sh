...
az vm run-command invoke -g $GROUP -n mongo-config --command-id RunShellScript \
--scripts "mkdir /docker && chmod 777 /docker && curl https://raw.githubusercontent.com/danielgron/db_assignment3_mongodb_sharding/main/docker-compose.config.yml -o /docker/docker-compose.yml"
